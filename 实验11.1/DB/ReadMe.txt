================================================================================
    MICROSOFT 基础类库 : DB 项目概述
===============================================================================

应用程序向导已为您创建了此 DB 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 DB 应用程序的每个文件的内容。
...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 DB.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一个视图：

DBView.h、DBView.cpp - 文档视图
    这些文件包含 CDBView 类。
...
DBSet.h, DBSet.cpp
    这些文件包含 CDBSet 类。此类用于访问在向导中选定的数据源。
    不会添加任何序列化支持。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 DB.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
